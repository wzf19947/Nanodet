...
def parse_args():
    ...
    parser.add_argument("--config", default='config/nanodet-plus-m_416_QR.yml',help="model config file path")
    parser.add_argument("--model", default = './workspace/nanodet-plus-m_416_Feng/model_best/model_best.ckpt',help="model file path")
    parser.add_argument("--path", default="./test", help="path to images or video")
